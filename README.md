[README.md](https://github.com/user-attachments/files/29124873/README.md)
# 👻 ghosttag
...
| **Excel** | `.xlsx` `.xls` | Cell values across all sheets, **hidden sheet detection**, creator and description metadata via `openpyxl` |
...
| `-o OUTPUT` | Output report path | `ghosttag_<date>.txt` |
